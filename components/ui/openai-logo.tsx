...
export interface OpenAILogoHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface OpenAILogoProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const OpenAILogo = forwardRef<OpenAILogoHandle, OpenAILogoProps>(
