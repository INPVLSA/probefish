...
export interface DeepSeekLogoProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

export interface DeepSeekLogoHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}
...
const DeepSeekLogo = forwardRef<DeepSeekLogoHandle, DeepSeekLogoProps>(
